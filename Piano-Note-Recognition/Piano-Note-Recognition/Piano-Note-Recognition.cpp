// Piano-Note-Recognition.cpp : Defines the entry point for the console application.
//
...
int main()
{
	...
	LookUpTable T;
	std::cout << T.closestHarmonic(250) << T.closestHarmonic(260);
	...
	{
		t2 = clock();
	} while ((double)(t2 - t1) < 30000);//rec.count() < 50);
